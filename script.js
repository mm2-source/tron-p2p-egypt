...
function setAdMode(mode) {
    ...
    if(mode === 'buy') {
        // BUY MODE: GREEN TAB (RIGHT) - ZERO RESTRICTIONS
        ...
        // FORCE-HIDE Max button and Available text in Buy mode
        balanceDiv.style.display = 'none';
        maxBtn.style.display = 'none';
        
        // Reset container to neutral black border
        amountContainer.style.borderColor = 'black';
        amountContainer.style.borderWidth = '1px';
        amountContainer.style.borderStyle = 'solid';
        ...
        showToast('', 'success'); // Clear any error messages
        
    } else {
        // SELL MODE: RED TAB (LEFT) - BALANCE LOCK
        ...
        // SHOW Max button and Available text in Sell mode
...
async function handleBalanceCheck(input) {
    if (adFormMode === 'buy') {
        // BUY MODE: ZERO RESTRICTIONS
        return handleBuyModeValidation(input);
    } else {
        // SELL MODE: STRICT BALANCE LOCK
        return await handleSellModeValidation(input);
    }
}
